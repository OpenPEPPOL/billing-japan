...
= Code list for invoice type code (IBT-3)

The following sub-chapters give an overview of the restricted set of invoice type codes (IBT-3) that is used in this PEPPOL BIS Billing.
