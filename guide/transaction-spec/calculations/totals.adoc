...
| stem:[sum("BT-117: CT category tax amount")]


| BT-112
| Invoice total amount with CT
| stem:[\ \ \ \ "BT-109: Invoice total amount without CT"] +
stem:[+ \ "BT-110: Invoice total CT amount"]

| BT-115
| Amount due for payment
| stem:[\ \ \ \ "BT-112: Invoice total amount with CT"] +
